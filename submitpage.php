	...
	<?php
			...
			{ 
			    ...
			    { 
					...
					echo "<td id='test' height=100 width=100>" . $query_executed['email']. " </td>";
					echo "<td id='test' height=100 width=100>" . $query_executed['address']. " </td>";
					// echo "<td>" . $query_executed['Item Picture']. "</td>";
					// echo $picture;
					// echo "<td> <img src=".$query_executed['address']." alt='' border=3 height=100 width=200></img> </td>";
